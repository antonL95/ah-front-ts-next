                    ...
                    <div className={`pl-5`} key={`${key}-${(new Date).getTime()}-div`}>
                        ...
                        {value.percentage !== ""
                         ? <h3 className={`text-6xl text-black font-extralight font-urbanist`}
                             ...
                             {value.percentage}<span className={`text-3xl font-extralight`}
                                                     key={`${key}-${(new Date).getTime()}-span`}> %</span>
                         </h3>
                         : ""
                        }
                        {value.subheadline !== ""
                         ?
                         <p className={`text-lg text-gray-60 mb-8 mt-2`} key={`${key}-${(new Date).getTime()}-p1`}>
                             {value.subheadline}
                         </p>
                         : ""
                        }
